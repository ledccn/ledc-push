...
class Server
{
     ...
     * @var string|int
     */
    protected string|int $_globalID = 1;
    ...
    public function onMessage(TcpConnection $connection, string $data): void
    {
        ...
        try {
            ...
            $connection->send($this->error($throwable->getCode(), $throwable->getMessage()));
        }
    }
     ...
     * @return string
     */
    protected function createChannelKey(string $app_key, string $channel): string
    {
    ...
    public function onApiClientMessage($connection, Request $request)
    {
        ...
        switch ($type) {
            ...
            case 'channels':
                ...
                return $connection->send(json_encode($channel_info, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES));
            default:
                return $connection->send(new Response(400, [], 'Bad Request'));
        }
    }
